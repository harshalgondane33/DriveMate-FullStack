...
const Navbar = () => {
  const {setShowLogin,showLogin,user,logout,isOwner,axios,setIsOwner} = useAppContext();
  ...
  return (
    ...
    >
      ...
      <div
        className={`max-sm:fixed max-sm:h-screen max-sm:top-16 max-sm:border-t border-borderColor right-0 flex flex-col sm:flex-row 
