...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subTitle="Monitor overall platform performance including total cars,bookings,revenue, and
       recent activities" />
       <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl'>
        {
          dashboardsCard.map((card,index)=>(
       ...
       <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
         <div className='p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full'>
          <h1 className='text0lg font-medium'>Recent Bookings</h1>
         ...
         <div className='p-4 md:pd-6 mb-6 border border-borderColor rounded-md w-full md:max-w-xs'>
